...
//
//public class MapGenFilledCaveGen extends MapGenBaseMeta { TODO 1.13
...
//	public IBlockState filledBlock;
//
//	public MapGenFilledCaveGen(Block block, int surfaceMeta, int subSurfaceMeta, int stoneMeta, IBlockState filledBlock) {
//		this.block = block;
...
//													primer.setBlockState(localX, localY, localZ, this.filledBlock);
//												} else if (metadata == this.surfaceMeta && random.nextInt(MapGenFilledCaveGen.BREAK_THROUGH_CHANCE) == 0) {
//													primer.setBlockState(localX, localY, localZ, this.filledBlock);
//												}
//											}
//										}
